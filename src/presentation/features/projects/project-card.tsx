...
export function ProjectCard({ project }: { project: ProjectSummary }) {
  return (
    <Link href={`/projects/${project.id}`} className="block">
      <Card className="h-full border-border/80 bg-card transition duration-200 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-primary/5">
        ...
        <CardContent className="space-y-4">
          <div className="rounded-lg bg-muted/55 p-3">
            ...
            <Progress className="mt-2 h-1.5" value={project.progress} />
          </div>
