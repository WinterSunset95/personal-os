    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Tasks stay focused, with just enough context to act on them.
          </DialogDescription>
        </DialogHeader>
        <form
          onSubmit={(event) => {
            ...
            const input = {
              ...
              focusDate: String(form.get("focusDate") ?? ""),
            };
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="grid gap-1.5">
              <Label htmlFor="focusDate">Focus date</Label>
              <Input
                id="focusDate"
                name="focusDate"
                type="date"
                defaultValue={task?.focusDate ?? ""}
              />
            </div>
          </div>
          {task && (
